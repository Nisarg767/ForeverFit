...
class TrainerDetailPage2 extends StatefulWidget {
  final Trainer _trainer;

  TrainerDetailPage2(this._trainer);

  @override
  _TrainerDetailPageState createState() => _TrainerDetailPageState();
}

class _TrainerDetailPageState extends State<TrainerDetailPage2> {
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              SizedBox(width: 12),
                              Expanded(child: _buildButton2("Contact")),
                            ],
                          ),
                        ],
                      ),
